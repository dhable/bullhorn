...
var recipientFields = ["domain", "firstName", "lastName", "timeZone", "drains"],
...
var save = function(firebase, id, recipient, accept, reject) {
   ...
   firebase.child(id).set(recipientCopy, function(err) {
      if(!err) {
...
var del = function(firebase, recipientId) {
   return new rsvp.Promise(function(accept, reject) {
      firebase.child(recipientId).remove(function(err) {
         if(!err) {
            accept();
            return;
         }
