...
var schema = {
   ...
   pigeon: {
      queue: {
         broker: {
            doc: "Default AMQP URL for the Pigeon service.",
            default: "amqp://jetway:jetway@localhost"
         }
      }
   },
   ...
   db: {
      firebase: {
         host: {
            doc: "Hostname of the Firebase instance to use.",
            default: "jetway-test.firebaseIO.com"
         },
         authKey: {
            doc: "Firebase authentication key from their application console.",
            default: "e4YIKFbz7Pum32wIRIH1cOcAorGaOxetZnKEI0Ai"
         }
      }
   },
   statsd: {
