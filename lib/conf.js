...
var schema = {
  ...
  db: {
    doc: "Location for LevelDB to store the files.",
    default: "./.db"
  },
  closeGrace: {
    doc: "Number of seconds to wait for a DB close before going down dirty.",
    default: 15
  },
  stats: {
    periodLength: {
      doc: "The number of seconds to aggerate drain statistics into single numbers.",
      default: 0
    },
    retentionLength: {
      doc: "The number of aggerate drain statistics to keep in memory.",
      default: 0
    }
  },
  sms: {
