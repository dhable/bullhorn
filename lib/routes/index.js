...
var App = require("./application.js"),
    ...
    Null = function(req, res, next) { res.send(200, "ok"); return next(); };
...
exports.bind = function(server) {
   ...
   server.post({path: "/applications/:appId/key", version: "1.0.0"},
      Security.authorize, App.loadEntity, Security.generateAPIKey, App.updateEntity, App.returnKey);

   server.del({path: "/applications/:appId/key", version: "1.0.0"},
      Security.authorize, App.loadEntity, App.updateEntity);

   server.get({path: "/applications/:appId/logs", version: "1.0.0"},
      Security.authorize, Null);
